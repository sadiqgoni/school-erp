                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:620px;background:#ffffff;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden">
                    <tr>
                        <td style="padding:26px 30px;border-bottom:1px solid #eef2f7">
                            ...
                            <div style="font-size:13px;color:#64748b;margin-top:2px">{{ $school?->name ?? config('app.name') }}</div>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:30px">
                            <h1 style="margin:0 0 14px;font-size:22px;line-height:1.3;color:#111827">Your portal login is ready</h1>

                            <p style="margin:0 0 16px">Hello {{ $name }},</p>

                            <p style="margin:0 0 18px">
                                Your {{ $roleLabel }} login is ready for {{ $school?->name ?? config('app.name') }}. Use the details below to sign in.
                            </p>
                            ...
                            <p style="margin:0 0 26px">
                                <a href="{{ $portalUrl }}" style="display:inline-block;background:#0f766e;color:#ffffff;text-decoration:none;font-weight:700;padding:12px 18px;border-radius:7px">Open portal</a>
                            </p>

                            <p style="margin:0;color:#64748b;font-size:13px">
                                Regards,<br>{{ $school?->name ?? config('app.name') }}
                            </p>
                        </td>
                    </tr>
                </table>
