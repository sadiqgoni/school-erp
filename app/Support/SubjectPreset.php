    ...
    protected static function template(string $template): array
    {
        return match ($template) {
            'nursery' => [
                ...
                ['name' => 'Pre-Writing Skills', 'code' => 'PWS', 'department' => 'Nursery'],
                ['name' => 'Writing', 'code' => 'WRT', 'department' => 'Nursery'],
                ['name' => 'Health Habits', 'code' => 'HHB', 'department' => 'Nursery'],
                ['name' => 'Creative Activities', 'code' => 'CAT', 'department' => 'Nursery'],
                ['name' => 'Social Habits', 'code' => 'SHB', 'department' => 'Nursery'],
            ],
            'primary' => [
                ...
                ['name' => 'Basic Technology', 'code' => 'BTE', 'department' => 'Primary'],
                ['name' => 'Social Studies', 'code' => 'SOS', 'department' => 'Primary'],
                ['name' => 'Civic Education', 'code' => 'CVE', 'department' => 'Primary'],
                ['name' => 'National Values', 'code' => 'NVA', 'department' => 'Primary'],
                ['name' => 'Agricultural Science', 'code' => 'AGR', 'department' => 'Primary'],
                ['name' => 'Home Economics', 'code' => 'HEC', 'department' => 'Primary'],
            ...
            'junior_secondary' => [
                ...
                ['name' => 'Home Economics', 'code' => 'HEC', 'department' => 'Junior Secondary'],
                ['name' => 'Cultural and Creative Arts', 'code' => 'CCA', 'department' => 'Junior Secondary'],
                ['name' => 'History', 'code' => 'HIS', 'department' => 'Junior Secondary'],
            ],
            'senior_secondary' => [
                ...
                ['name' => 'Commerce', 'code' => 'COM', 'department' => 'Senior Secondary'],
                ['name' => 'Financial Accounting', 'code' => 'ACC', 'department' => 'Senior Secondary'],
                ['name' => 'Geography', 'code' => 'GEO', 'department' => 'Senior Secondary'],
                ['name' => 'Further Mathematics', 'code' => 'FMT', 'department' => 'Senior Secondary'],
                ['name' => 'Data Processing', 'code' => 'DPR', 'department' => 'Senior Secondary'],
            ],
            'common' => [
                ...
                ['name' => 'Security Education', 'code' => 'SED', 'department' => 'General'],
            ],
            default => [],
        };
    }
